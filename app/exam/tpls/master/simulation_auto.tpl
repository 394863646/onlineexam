...
{x2;endif}
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?{x2;$_app}-master-simulation&page={x2;$page}{x2;$u}">试卷管理</a></li>
							<li class="active">发布试卷</li>
						</ol>
					</div>
				</div>
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
			        ...
			        <form action="index.php?exam-master-simulation-autopage" method="post" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<label class="radio-inline">
									<input name="args[examdecide]" type="radio" value="1" checked/>教师评卷
								</label>
								<!--<label class="radio-inline">
							...
							<div class="form-group questpanel panel_{x2;v:questype['questid']}">
								...
								<div class="col-sm-9 form-inline">
									...
									<span class="info">&nbsp;易&nbsp;</span><input class="form-control" type="text" name="args[examsetting][questype][{x2;v:questype['questid']}][easynumber]" value="0" size="1" msg="您需要填写简单题的数量，最小为0"/>
			  						...
			  						<!--<label><a title="导入题组" class="selfmodal" href="javascript:;" url="index.php?exam-master-simulation-detail&questiontype={x2;v:questype['questype']}" data-target="#modal">导入题组</a></label>-->
								</div>
