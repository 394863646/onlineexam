<div id="elayer" class="elayer">
	...
	<div class="summary">总分:{x2;$paper['examsetting']['score']}分 及格:{x2;$paper['examsetting']['passscore']}分 时间:{x2;$paper['examsetting']['examtime']}分钟</div>
	<div id="plinkbox">
		...
		{x2;eval:$i=0;}
		 {x2;tree:$groups,_group,_gid}
			{x2;tree:v:_group['list'],val,id}
				{x2;if:$i++ % 7==0}<tr align="middle" bgColor="#ffffff">{x2;endif}
				<td id="a_{x2;v:val['eid']}" class="e">{x2;$i}</td>
			{x2;endtree}
		{x2;endtree}
		</table>
	</div>
