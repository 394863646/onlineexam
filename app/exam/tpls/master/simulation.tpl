				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						...
						<span class="pull-right">
							<a class="btn btn-primary" href="index.php?{x2;$_app}-master-simulation-autopage&page={x2;$page}{x2;$u}">添加试卷 </a>
			        ...
			        <table class="table table-hover table-bordered">
			            ...
			            <tbody>
					        ...
					        <tr>
								...
								<td>
									{x2;if:v:exam['examtype'] == 1}随机组卷{x2;elseif:v:exam['examtype'] == 2}手工组卷{x2;elseif:v:exam['examtype'] == 3}即时组卷{x2;else}上传发布{x2;endif}
								</td>
								<td>
								...
								<td>
									<div class="btn-group">
			                    		...
			                    		<a class="btn" target="_blank" href="index.php?{x2;$_app}-master-simulation-preview&examid={x2;v:exam['examid']}{x2;$u}" title="查看试卷"><em class="glyphicon glyphicon-list-alt"></em></a>
			                    		
			                    		{x2;endif}
			                    		{x2;if:v:exam['examtype'] == 3 || v:exam['examtype'] == 8}
			                    		<a class="btn ajax" href="index.php?{x2;$_app}-master-simulation-outcsv&page={x2;$page}&examid={x2;v:exam['examid']}{x2;$u}" title="下载csv"><em class="glyphicon glyphicon-download-alt"></em></a>
			                    		{x2;endif}
