		...
		function exam_submit_get_result(){
			...
			if(TIME_LEFT>0 && SUBMIT_WAIT-TIME_PASS>0){
				//showError('���Կ�ʼ������ '+ Math.ceil(SUBMIT_WAIT/60) +' ���Ӻ���ܽ���, ���ٵȴ�: '+  time_second_ms(SUBMIT_WAIT-TIME_PASS));
		...
		function result_msg_print(){
			...
			for(var i=0; i<marks.length; i++){
				...
				var score = each_exam_score_cal( eid );//�û��÷�
			...
			$('p_result').innerHTML = '<p><em>'+user_score+'</em>&#x5206;</p><p>'+(user_score >= SCORE_PASS ? '&#x6210;&#x7EE9;&#x5408;&#x683C;' : '&#x6210;&#x7EE9;&#x4E0D;&#x5408;&#x683C;')+'</p>';//�ɼ��ϸ�' : '�ɼ����ϸ�
		...
		//���б��е�ÿһ�����������¼�,����label����,��ѡ��,��ѡ��,�ж����onclick, ��պ�������հ���onchange
		function label_bind_click(){
			var form = $('#examination_form');
			if(!form)return false;
			var marks = form.find('map');
			...
			for(var i=0; i<marks.length; i++){
				...
				marks[i].parentNode.getElementsByTagName('a')[0].click(function(){
		...
		function time_counter(){
			if(TIME_LEFT==300){
				//showError('ע�⣬����5���ӿ��Խ���, ���Խ������Զ�����!');  		
				showError('&#x6CE8;&#x610F;&#xFF0C;&#x8FD8;&#x6709;5&#x5206;&#x949F;&#x8003;&#x8BD5;&#x7ED3;&#x675F;, &#x8003;&#x8BD5;&#x7ED3;&#x675F;&#x540E;&#x5C06;&#x81EA;&#x52A8;&#x4EA4;&#x5377;!');				
			}
			else if(TIME_LEFT==60){
				//showError('ע�⣬����1���ӿ��Խ���, ���Խ������Զ�����!');  	
