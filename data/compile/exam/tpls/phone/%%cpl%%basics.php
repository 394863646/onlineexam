...
<?php } ?>
		...
		<div class="container-fluid">
			<div style="clear:both;overflow:hidden;background:#FFFFFF;margin-top:0.5rem">
				...
				<?php } ?>
				<?php if(!$this->tpl_var['data']['currentbasic']['basicexam']['model']){ ?>
				<div class="col-xs-4">
					<a href="index.php?exam-phone-test" class="thumbnail ajax" style="border:0px;" data-target="exams" data-page="exams">
						<img src="app/core/styles/img/t3.png" alt="" width="100%">
					</a>
					<h5 class="text-center">仿真模考</h5>
				</div>
				<?php } ?>
			</div>
		</div>
