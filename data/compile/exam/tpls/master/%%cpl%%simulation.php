...
<?php } ?>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						...
						<span class="pull-right">
							<a class="btn btn-primary" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-simulation-autopage&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>">添加试卷 </a>
			        ...
			        <form action="index.php?exam-master-simulation" method="post" class="form-inline">
						<table class="table">
							<thead>
				                <tr>
							        <th colspan="2">搜索</th>
 ...
 $eid++; ?>
					        <tr>
								...
								<td>
									<?php if($exam['examtype'] == 1){ ?>随机组卷<?php } elseif($exam['examtype'] == 2){ ?>手工组卷<?php } elseif($exam['examtype'] == 3){ ?>即时组卷<?php } else { ?>上传发布<?php } ?>
								</td>
								<td>
								...
								<td>
									<div class="btn-group">
			                    		...
			                    		<a class="btn" target="_blank" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-simulation-preview&examid=<?php echo $exam['examid']; ?><?php echo $this->tpl_var['u']; ?>" title="查看试卷"><em class="glyphicon glyphicon-list-alt"></em></a>
			                    		
			                    		<?php } ?>
			                    		<?php if($exam['examtype'] == 3 || $exam['examtype'] == 8){ ?>
			                    		<a class="btn ajax" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-simulation-outcsv&page=<?php echo $this->tpl_var['page']; ?>&examid=<?php echo $exam['examid']; ?><?php echo $this->tpl_var['u']; ?>" title="下载csv"><em class="glyphicon glyphicon-download-alt"></em></a>
			                    		<?php } ?>
